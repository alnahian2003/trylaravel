<template>
    <AuthenticatedLayout>
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-xl text-gray-600">{{ totalLikes }} liked articles</p>
                    </div>
            ...
            <!-- Liked Posts Grid -->
            <InfiniteScroll data="likedPosts" :buffer="500">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div 
                        v-for="post in likedPosts.data" 
                        :key="post.id"
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <button 
                                    ...
                                    class="text-red-500 hover:text-red-700 transition-colors p-1 hover:bg-red-50 rounded-lg"
                                >
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                                <span class="text-xs text-gray-500">
                                    ...
                                    Liked {{ formatDate(post.created_at) }}
                                </span>
                                <button 
            ...
            <!-- Empty State -->
            <div v-if="!likedPosts.data.length" class="text-center py-16">
                <div class="max-w-md mx-auto">
                    <div class="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-heart text-gray-400 text-3xl"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-3">No liked posts yet</h3>
                    <p class="text-gray-600 mb-6">Start liking articles from your feed to see them here.</p>
                    <Link 
                        :href="route('home')"
...
const filterByCategory = (category) => {
    ...
    router.get(route('liked-posts'), params, {
        preserveState: true,
        preserveScroll: true,
    })
}
...
const removeLike = (postId) => {
    // This would make an API call to remove the like
    console.log('Remove like for post:', postId)
}
</script>
